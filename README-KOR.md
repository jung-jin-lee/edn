...
**edn**은 _values_의 수송을 위한 시스템입니다. 그것은 타입 시스템이 아니고, 스키마를 가지고 있지 않습니다. 그것은 객체(object)를 표현하기 위한 시스템이 아니고 - 참조 타입이 없고, **edn**의 본문 어딘가에 두개의 동일한 요소를 가질 것으로 소비자는 예상하지 않습니다.
